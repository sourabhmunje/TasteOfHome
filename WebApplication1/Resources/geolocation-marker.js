...
(function ()
    {
        ...
        function g(a, c, e)
        {
            ...
            this.a = this.b = null; this.g = -1;
            var f =
                {
                    clickable: !1, cursor: "pointer", draggable: !1, flat: !0, icon:
                        {
        ...
        (function ()
        {
            ...
            function c() { } c.prototype = a.prototype;
            g.prototype = new c;
        ...
        b.i = function () { return this.get("map") };
        b.l = function () { return this.get("position_options") };
        b.w = function (a) { this.set("position_options", a) };
        b.c = function () { return this.get("position") };
        b.m = function () { return this.get("position") ? this.a.getBounds() : null };
        b.j = function () { return this.get("accuracy") };
        b.h = function () { return this.get("minimum_accuracy") };
        b.v = function (a) { this.set("minimum_accuracy", a) };
        b.f = function (a)
        {
        ...
        b.A = function (a)
        {
            ...
            if (e)
            {
                if (null != this.h() && a.coords.accuracy > this.h())
                    return;
                this.b.setMap(this.i()); this.b.bindTo("position", this);
            ...
            !e && null != this.c() && this.c().equals(c) || google.maps.MVCObject.prototype.set.call(this, "position", c)
        };
        ...
        "function" === typeof
        this.define && this.define.amd ? this.define([], m) : "object" === typeof this.exports ? this.module.exports = m() : this.GeolocationMarker = m();
    }
).call(this)
